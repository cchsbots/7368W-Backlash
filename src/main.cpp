...
void pre_auton(void)
{
  ...
  Menu.registerAuton("Left Corner", autonomous1);
  Menu.registerAuton("Right Corner", autonomous2);
  Menu.registerAuton("Skills", autonomous3);
}
...
int main()
{
  ...
  thread blockThread(blockDetect);
